...
const emit = defineEmits(["submit", "googleLogin", "forgot-password"])
  ...
  <form @submit.prevent="submitForm" class="space-y-6">
    ...
    <div>
      ...
      <div class="text-right mt-2">
        <a href="#" @click.prevent="$emit('forgot-password')" class="text-sm text-indigo-900 hover:text-indigo-800 font-medium">
          Lupa Password?
        </a>
      </div>
    </div>
    ...
    <button 
      ...
      :disabled="loading"
      class="w-full flex justify-center items-center py-3 px-6 border border-gray-300 rounded-3xl shadow-md
